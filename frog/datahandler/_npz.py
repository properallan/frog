...
class DataHandlerNpz:
    def __init__(self, npz_file):
        ...
        self.snapshot_index = eval(self.data['snapshot_index'][0])
        self.variables = self.snapshot_index.keys()
        self.snapshots = IndexedArray(self.data['snapshots'],self.snapshot_index)
